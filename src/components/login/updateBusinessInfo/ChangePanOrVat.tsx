...
export default function ChangePanOrVat(props: any) {
  ...
  return (
    <div className="flex relative flex-col pt-14 px-10 pb-5 items-center xxs:justify-center md:justify-center text-black h-full w-full">
      ...
      <label
        className="bg-error-primary flex items-center justify-center text-white rounded uppercase w-3/4 h-10 my-2 cursor-pointer"
      ...
      <button
        className="bg-blue-700 text-white rounded uppercase w-3/4 h-10 my-2 mb-10"
        onClick={incStep}
      >
        CONTINUE
      </button>
