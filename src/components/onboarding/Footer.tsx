...
import qrCode from "/public/icons/qrcode.svg";
import Image from "next/image";

const Footer = () => {
  return (
    <>
      <div className="relative h-[400px] md:h-[641px] lg:h-[435px] w-full bg-blue-800 text-white p-10 md:px-[100px] lg:px-[210px] z-20">
        <div className="absolute flex justify-end bottom-14 md:bottom-28 lg:bottom-4 right-2 md:right-10 lg:right-[-40px] h-[167px] w-[167px] md:h-[300px] md:w-[300px] lg:h-[375px] lg:w-[375px]">
