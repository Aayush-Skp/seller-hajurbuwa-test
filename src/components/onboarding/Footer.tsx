      ...
      <div className="grid grid-cols-2 xl:grid-cols-3">
        <div className="flex flex-col justify-start items-start w-full">
          <div className="flex flex-col justify-start items-start text-left w-full">
            ...
            <Link href="/login"><div className="mb-2 text-xs md:text-xl">Login as seller</div></Link>
            <Link href="/register"> <div className="mb-2 text-xs md:text-xl">Register as seller</div> </Link>
          </div>
        </div>
            ...
            {policies &&
              policies.map((policy: any) => {
                return (
                  <Link
                    key={policy.id}
                    href={`https://hajurbuwa.com/policies/${policy.slug}`}
                    legacyBehavior>
