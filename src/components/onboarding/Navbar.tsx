...
const Navbar = () => {
  return (
    <div className="pt-[66px] pb-[20px] lg:pt-[25px] px-8 lg:px-52  flex justify-between items-center">
      <div className="flex justify-center items-center">
        <Image src={hajurbuwMobileLogo} alt={'Hajurbuwa MObile Logo'} />

        <div className="hidden font-extrabold text-white ml-2 leading-tight text-4xl">
          Hajurbuwa
        </div>
      </div>
      <div className="hidden justify-end items-center lg:w-2/5 xl:w-1/3 ">
